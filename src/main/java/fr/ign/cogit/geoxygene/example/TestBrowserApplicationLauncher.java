...
/**
 * Classe de test pour le navigateur d'objets graphique de GeOxygene
 * (ObjectBrowser), permettant de montrer comment on peut construire, à moindre
 * frais, une interface graphique de lancement pour une application comportant
 * plusieurs traitements enchainables.
 * 
